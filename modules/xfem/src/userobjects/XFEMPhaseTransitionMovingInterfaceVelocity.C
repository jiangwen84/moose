    ...
    dof_id_type point_id, RealVectorValue normal) const
{
  ...
  // _value_at_interface_uo->getGradientAtPositiveLevelSet()[point_id]; RealVectorValue
  // grad_negative = _value_at_interface_uo->getGradientAtNegativeLevelSet()[point_id];
  //
  ...
  // return _value_at_interface_uo->getValueAtPositiveLevelSet()[point_id];
  // return _value_at_interface_uo->getGradientAtPositiveLevelSet()[point_id] * normal;
  return 0.1111;
}
