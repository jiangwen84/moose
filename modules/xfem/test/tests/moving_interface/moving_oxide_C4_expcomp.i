...
[Mesh]
  [./cmg]
    ...
    dim = 2
    dx = '650 600' # 1250 um = half of coupons thickness
    dy = '4'#'800'
    ix = '65 601'
    iy = '2'
  [../]
...
[UserObjects]
  [./velocity_ox_a]
    type = XFEMC4VelocityZrOxAExpcomp
