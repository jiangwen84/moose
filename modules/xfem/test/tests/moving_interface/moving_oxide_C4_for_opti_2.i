...
# This file is used for the diffusion coefficients optimization.
# New version with left BC = zero flux (Neumann) instead of fixed concentration
# and the same initial interface position at every T
