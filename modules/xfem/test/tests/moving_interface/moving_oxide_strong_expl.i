...
[UserObjects]
  [./velocity]
  type = XFEMC4VelocityZrOxAExample
...
[Constraints]
  [./u_constraint]
    ...
    variable = u
    value_at_positive_level_set_interface = 0.5
    value_at_negative_level_set_interface = 0.95
    alpha = 1e5
  [../]
[]
