...
#ifndef XFEMC4VelocityZrOxAExpcomp_H
#define XFEMC4VelocityZrOxAExpcomp_H
...
class XFEMC4VelocityZrOxAExpcomp;

template <>
InputParameters validParams<XFEMC4VelocityZrOxAExpcomp>();

class XFEMC4VelocityZrOxAExpcomp : public XFEMMovingInterfaceVelocityBase
{
public:
  XFEMC4VelocityZrOxAExpcomp(const InputParameters & parameters);
  virtual ~XFEMC4VelocityZrOxAExpcomp() {}
...
#endif // XFEMC4VELOCITYZROXAExpcomp_H
