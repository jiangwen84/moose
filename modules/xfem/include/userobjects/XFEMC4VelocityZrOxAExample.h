...
#ifndef XFEMC4VelocityZrOxAExample_H
#define XFEMC4VelocityZrOxAExample_H
...
class XFEMC4VelocityZrOxAExample;

template <>
InputParameters validParams<XFEMC4VelocityZrOxAExample>();

class XFEMC4VelocityZrOxAExample : public XFEMMovingInterfaceVelocityBase
{
public:
  XFEMC4VelocityZrOxAExample(const InputParameters & parameters);
  virtual ~XFEMC4VelocityZrOxAExample() {}
...
#endif // XFEMC4VELOCITYZROXAExample_H
