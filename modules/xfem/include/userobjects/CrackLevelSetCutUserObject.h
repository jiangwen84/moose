...
class CrackLevelSetCutUserObject : public GeometricCutUserObject
{
public:
  static InputParameters validParams();

  CrackLevelSetCutUserObject(const InputParameters & parameters);
...
protected:
  ...
  const unsigned int _level_set_phi_number;

  /// The variable number of the level set variable we using to define the cuts
  const unsigned int _level_set_psi_number;
