...
template <>
InputParameters validParams<C4ZrICConstExpcomp>();

/**
 * Defines a boundary condition that forces the value to be a user specified
 * function at the boundary.
 */
class C4ZrICConstExpcomp : public InitialCondition
{
public:
  static InputParameters validParams();

  C4ZrICConstExpcomp(const InputParameters & parameters);
