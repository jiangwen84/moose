...
if strcmp(temperature, '950C')
    time_exp_CP = [1344.9 977.9 1595.7 690.6 774.6 1300.2 948.7 1634.5 412.2 428.7];
    d_exp_CP = [26.5 23.1 26.2 21.3 22.5 25.1 22.0 26.3 17.9 18.0];
    alpha_exp_CP = [24.1 18.9 25.2 15.7 16.9 22.3 19.9 26.4 13.0 15.3];
    wg_exp_CP = [4.62 3.97 4.61 3.62 3.83 4.37 3.83 4.65 3.04 3.11];
    time_CP_max = 1500;
end
...
% Starting values
Da_Matlab =[0.17 0.5 2.425 10.3 29.9063 75.25 170];        % Diffusion coefficients in the aplha phase for every T [�m�/s]
Db_Matlab =[20 30 81.8 250 687.1875 702 1200];         % Diffusion coefficients in the beta phase for every T [�m�/s]
...
wg_C_MOOSE = data(1:length(data),6);
